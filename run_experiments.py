...
# Modifications: Change process name, define new parameters and other fixes
...
if __name__ == '__main__':
    ...
    parser.add_argument(  # it shows the presence of unlabeled source TODO: Modifications GenGMM
        '--unlabeled',  # it shows the presence of unlabeled source TODO: Modifications GenGMM
        action='store_true',  # it shows the presence of unlabeled source TODO: Modifications GenGMM
        help='Experiment unlabeled',  # it shows the presence of unlabeled source TODO: Modifications GenGMM
    )
    parser.add_argument(  # it shows the presence of weakly target TODO: Modifications GenGMM
        '--weak_target',  # it shows the presence of weakly target TODO: Modifications GenGMM
        action='store_true',# it shows the presence of weakly target TODO: Modifications GenGMM
        help='Experiment weak_target',  # it shows the presence of weakly target TODO: Modifications GenGMM
    )
    ...
    if args.config is not None:
        setproctitle.setproctitle(f'CFG: {args.config}')
    ...
    if args.exp is not None:
        setproctitle.setproctitle(f'ProtoGMM EXP: {args.exp}')
        ...
        for i, cfg in enumerate(cfgs):
            ...
            cfg['unlabeled'] = args.unlabeled  #TODO: Modifications GenGMM
            cfg['weak_target'] = args.weak_target  # TODO: Modifications GenGMM
