...
def generate_experiment_cfgs(id):
    def config_from_vars():
        ...
        cfg['exp'] = id
        cfg['unlabeled'] = unlabeled  # it shows the presence of unlabeled source data # TODO: Modifications GenGMM
        cfg['weak_target'] = weak_target  # it shows the presence of weakly target data TODO: Modifications GenGMM
    ...
    # -------------------------------------------------------------------------
    cfgs = []
    method_name = 'ProtoGMM'
    n_gpus = 1
    unlabeled = False  # it shows the presence of unlabeled source data # TODO: Modifications GenGMM
    weak_target = True  # it shows the presence of weakly target data TODO: Modifications GenGMM
    batch_size = 2
    iters = 60000
    ...
    # -------------------------------------------------------------------------
    # GTA -> Cityscapes [ProtoGMM] (ResNet-101)
    # -------------------------------------------------------------------------
    if id == 1:
        # task
    ...
    # -------------------------------------------------------------------------
    # GTA -> Cityscapes [ProtoGMM] (MiT-B5)
    # -------------------------------------------------------------------------
    elif id == 2:
        # task
    ...
    # -------------------------------------------------------------------------
    # Synthia -> Cityscapes [ProtoGMM] (MiT-B5)
    # -------------------------------------------------------------------------
    elif id == 3:
        # task
        model = ('daformer_sepaspp_proj', 'mitb5')
