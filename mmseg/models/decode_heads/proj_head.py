...
# Modifications: Model construction with projection head
...
class ProjHead(BaseDecodeHeadDecorator):
    ...
    def __init__(self,
        ...
        if self.input_transform == 'multiple_select':
            ...
            self.embedding_dim = 64 # TODO: Modifications
            if self.channels != self.embedding_dim:  # TODO: Modifications
                self.projection = ConvModule(  # TODO: Modifications
                    in_channels=self.channels,  # TODO: Modifications
                    out_channels= self.embedding_dim,  # TODO: Modifications
                    kernel_size=1,  # TODO: Modifications
                    norm_cfg=self.norm_cfg)  # TODO: Modifications
            else:
                self.projection = None  # TODO: Modifications
    ...
    def forward(self, inputs):
        ...
        if isinstance(x, list):
            ...
            # output = F.normalize(self.convs(x), p=2, dim=1)  # TODO: Modifications GenGMM
            x = self.convs(x)  # TODO: Modifications GenGMM
            output = self.projection(x)  # TODO: Modifications GenGMM
        return output
