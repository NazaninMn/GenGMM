...
def main(args):
    ...
    if args.seed is None and 'seed' in cfg:
        args.seed = cfg['seed']
        args.unlabeled = cfg['unlabeled']  # TODO: Modification GenGMM
        args.weak_target = cfg['weak_target']  # TODO: Modification GenGMM
    ...
    logger.info(model)
    cfg.data.train.unlabeled = cfg['unlabeled']  # TODO: Modification GenGMM
    cfg.data.train.weak_target = cfg['weak_target']  # TODO: Modification GenGMM
